...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  ...
  >
    ...
    <path d="M6 5a3 3 0 0 0 5.993.142" />
    <path d="M12 12a3 3 0 0 0 5.993.142" />
    <path d="M6 12a3 3 0 0 0 5.993.142" />
    <path d="M12 19a3 3 0 0 0 5.993.142" />
    <path d="M6 19a3 3 0 0 0 5.993.142" />
    <path d="M9 7.857a2.983 2.983 0 0 0 0 8.286" />
    <path d="M15 7.857a2.983 2.983 0 0 1 0 8.286" />
    <path d="M6.007 8A2.99 2.99 0 0 1 9 7.857" />
    <path d="M6.007 16A2.99 2.99 0 0 0 9 16.143" />
    <path d="M15 7.857A2.99 2.99 0 0 1 17.993 8" />
    <path d="M15 16.143A2.99 2.99 0 0 0 17.993 16" />
  </svg>
);
...
export const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M9.93 2.13a2.46 2.46 0 0 1 4.14 0l.33 1a2.46 2.46 0 0 0 3.75 1.45l.8-.48a2.46 2.46 0 0 1 3.2 2.76l-.34.98a2.46 2.46 0 0 0 1.45 3.75l1 .33a2.46 2.46 0 0 1 0 4.14l-1 .33a2.46 2.46 0 0 0-1.45 3.75l.34.98a2.46 2.46 0 0 1-3.2 2.76l-.8-.48a2.46 2.46 0 0 0-3.75 1.45l-.33 1a2.46 2.46 0 0 1-4.14 0l-.33-1a2.46 2.46 0 0 0-3.75-1.45l-.8.48a2.46 2.46 0 0 1-3.2-2.76l.34-.98a2.46 2.46 0 0 0-1.45-3.75l-1-.33a2.46 2.46 0 0 1 0-4.14l1-.33a2.46 2.46 0 0 0 1.45-3.75l-.34-.98a2.46 2.46 0 0 1 3.2-2.76l.8.48a2.46 2.46 0 0 0 3.75-1.45l.33-1z"/>
    </svg>
);
...
export const Wand2Icon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="m3 21 8.7-8.7a2 2 0 0 1 2.8 0l2.1 2.1a2 2 0 0 1 0 2.8L8 21" />
        <path d="M21 3 12.3 11.7a2 2 0 0 1-2.8 0L7.4 9.6a2 2 0 0 1 0-2.8L16 3" />
        <path d="m15 6 3 3" />
        <path d="M5.5 13.5 4 12" />
        <path d="m13.5 5.5 1.5-1.5" />
    </svg>
);
...
export const ListCheckIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" />
        <path d="M15 2H9a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1Z" />
        <path d="m9 11 3 3L22 4" opacity="0" /> 
        <path d="m9 12 2 2 4-4" />
    </svg>
);
